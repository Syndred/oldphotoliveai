...
const ANIMATION_FORMATS = [
  ["JPG / JPEG", "Scanned prints and camera photos"],
  ["PNG", "Lossless scans and edited portraits"],
  ["WEBP", "Compact, high-quality web images"],
] as const;
        ...
        {slug === "animate" ? (
          <section className="px-4 py-10 sm:py-14">
            <div className="mx-auto max-w-5xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[var(--color-text-secondary)] sm:text-base">
                Upload a JPG, PNG, or WEBP portrait up to 10 MB. Clear, centered faces with minimal glare usually produce steadier motion.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                {ANIMATION_FORMATS.map(([format, description]) => (
                  <article key={format} className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-card-bg)] p-5">
                    <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">{format}</h3>
