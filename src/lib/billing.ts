...
export const CREDIT_PACKS = {
  starter_pack: {
    ...
    unitAmount: 499,
    currency: "usd",
    lookupKey: "oldphotoliveai_starter_pack_10_credits_usd_v1",
  },
  family_pack: {
    ...
    unitAmount: 999,
    currency: "usd",
    lookupKey: "oldphotoliveai_family_pack_25_credits_usd_v1",
  },
  archive_pack: {
    ...
    unitAmount: 1999,
    currency: "usd",
    lookupKey: "oldphotoliveai_archive_pack_60_credits_usd_v1",
  },
} as const;
