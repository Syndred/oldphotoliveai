    ...
    <>
      ...
      <main className="flex min-h-screen items-center justify-center bg-[var(--color-primary-bg)] px-4">
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-100 disabled:opacity-60 min-h-[44px]"
        >
          {loading ? (
