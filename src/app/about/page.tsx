              ...
              <section className="rounded-2xl border border-white/8 bg-white/[0.025] p-5 sm:p-6">
                ...
                <div className="mt-4 space-y-3">
                  <div>
                    ...
                    <a
                      className="mt-2 inline-flex min-h-[44px] items-center rounded-full border border-[var(--color-accent)]/30 bg-black/15 px-4 py-2 text-sm font-medium text-[var(--color-text-primary)] transition-colors hover:border-[var(--color-accent)]/50 hover:bg-black/25"
